    ...
    <form:form commandName="searchVO" name="listForm" method="post">
        ...
        <div class="sch_block3">
        	<li>
				...
				<%-- 	<option value="P" <c:if test="${searchVO.search_gubun == 'K'}" >selected</c:if>>임직원취약자</option> 
					<option value="P" <c:if test="${searchVO.search_gubun == 'C'}" >selected</c:if>>협력사취약자</option>  --%>
				</select>
